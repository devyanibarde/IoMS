	...
	<div class="bgprin">
        ...
        <div class="in">
            ...
            <div id="maincenter">
                ...
                ps1=con.prepareStatement("insert into mails(sender,body,receiver) values(?,?,?)");
                    ps1.setString(1, id+"HM");
                    ps1.setString(2, body);
                    ps1.setString(3, "admin");
                    ps1.executeUpdate();
                    %>Mail Sent
                <a href="/IoMS/jsp/PrincipalHomeJSP.jsp"><button>OK!</button></a>
                    ...
                    <div class="flip-card" style="">
                        <div class="flip-card-inner">
                            ...
                            <div class="flip-card-back">
                                ...
                                <a href="#"><button type="button" class="taskbutton2">View Profile</button></a>
                            </div>
                        </div>
                    </div>
                <%
