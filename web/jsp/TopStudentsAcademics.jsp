	...
	<div class="single-rb">
		...
		<div class="ad-main">
                    <div class="ad-grid" id="Disp" style="color:white">
                        <center><form id="sim" method="post" action="/IoMS/jsp/TopStudentsAcademics.jsp" style="margin: 20px;">
        ...
        <input class="stadd" type="submit" value="Show List">
                        ...
                        <a href="#" onclick="show('TopAca','1',<%=request.getParameter("cla")%>,<%=request.getParameter("number")%>)"><button class="stadd" style="background-color:#006666">Term I</button></a>
                        <a href="#" onclick="show('TopAca','2',<%=request.getParameter("cla")%>,<%=request.getParameter("number")%>)"><button class="stadd" style="background-color:#006666">Term II</button></a>
                        <a href="#" onclick="show('TopAca','3',<%=request.getParameter("cla")%>,<%=request.getParameter("number")%>)"><button class="stadd" style="background-color:#006666">Average of Both</button></a></br></br>
                        <div id="Disp1"></div></center>
