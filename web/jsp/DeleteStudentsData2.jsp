...
<html>
    ...
    %>
		<div class="bg">
			...
			<div class="hd4" id="wh">
				...
				<div class="hd6" style="color:white">
                                   <%
                                       String adn;
                                       adn=request.getParameter("q");
                                   ps4=con.prepareStatement("delete from student where adhaarno=?");
                                   ps4.setString(1,adn);
                                   ps4.executeUpdate();
    ...
    ps.setString(2, sect);
    ps.executeUpdate();
                                   %><center><h5 style="font-size:40px;">Students Data Successfully Deleted</br></h5></center>
    <a href="/IoMS/jsp/ClassTeacherJSP.jsp#wh" class="stadd" style="color:#ff1a1a;text-decoration:none;text-align:center;color:white">OK!</a>
				</div>
			</div>
			<div class="hd7">
				CopyRigths Reserved
