...
<div class="rotating-box">
	<div class="single-rb">
        ...
        %>
        <form method="post" action="/IoMS/jsp/MailTop1.jsp?q=<%=q%>&clas=<%=clas%>&num=<%=num%>&b=<%=b%>">
            <div class="admin-grid-txt">
                Send To:</div></br>
            
            <h1 style="color:#e6ccff;"><input type="checkbox" name="HM" value="P" checked>Principals
                <input type="checkbox" name="CT" value="C" checked>Class Teachers</h1></br>
            <textarea class="mailtxt" name="body">
                Students from your School/Class have been shortlisted.
            </textarea></br>
            <input type="checkbox" name="Attachment" value="A" checked><h1 style="color:#e6ccff;">Attach the PDF of selected students</h1>
            <center><input class="stadd" type="submit" value="Send"></center></br>
