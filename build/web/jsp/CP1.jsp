        ...
        if(curr.equals(rs2.getString("Password")))
            {
                %>
                <center><h5>Change Password</h5></center>
                <form name="frm" method="post" action="/IoMS/jsp/CP2.jsp">				
                    <div class="hrzline">
                    ...
                    <div class="flip-card" style="">
                        <div class="flip-card-inner">
                            ...
                            <div class="flip-card-back">
                                ...
                                <a href="/IoMS/jsp/VP.jsp?c=<%=rs2.getString("class")%>&s=<%=rs2.getString("section")%>">View Profile</button></a>
                            </div>
                        </div>
                    </div>
                <%
