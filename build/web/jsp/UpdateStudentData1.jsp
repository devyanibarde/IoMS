    ...
    %>
		<div class="bg">
			...
			<div class="hd2" id="mainwork">
                           ...
                           <center><h5 style="color:#ff3377">Update Students Details</h5></center>
                           <form name="frm" method="post" action="/IoMS/jsp/UpdateStudentData2.jsp?s=<%=rs2.getString("adhaarno")%>">
					
        <div class="hrzline">
            <input type="text" name="adno" value="<%=rs2.getString("adhaarno")%>" autocomplete="off" disabled>
            <label>Adhaar Number</label>
        </div>
          <div class="hrzline">
            <input type="text" name="nm" autocomplete="off" value="<%=rs2.getString("name")%>">
            <label>Name</label>
        </div>
        
           
          <div class="hrzline">
            <input type="text" name="ais" autocomplete="off" value="<%=rs2.getString("achisport")%>">
            <label>Achievement in Sports</label>
        </div>
          <div class="hrzline">
            <input type="text" name="aia" autocomplete="off" value="<%=rs2.getString("achiacadamics")%>">
            <label>Achievement in Academics</label>
        </div>
          <div class="hrzline">
            <input type="text" name="peri" autocomplete="off" value="<%=rs2.getString("termIper")%>">
            <label>Term I Percentage</label>
        </div>
          <div class="hrzline">
            <input type="text" name="perii" autocomplete="off" value="<%=rs2.getString("termIIper")%>">
